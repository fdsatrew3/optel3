...
namespace OPTEL.UI.Desktop.Views
{
    ...
    public partial class KnowledgeEngineersWindow : DatabaseEntityView
    {
        public KnowledgeEngineersWindow()
        {
            ...
            var userConverterService = new UserToDataUserConverterService<KnowledgeEngineer>();
            DataContext = new KnowledgeEngineersViewModel(windowCloseService, errorsListWindowService, userConverterService);
        }

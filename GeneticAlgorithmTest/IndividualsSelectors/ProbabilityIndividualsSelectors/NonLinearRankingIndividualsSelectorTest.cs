...
namespace GeneticAlgorithmTest.IndividualsSelectors.ProbabilityIndividualsSelectors
{
    ...
    {
        protected const double DEFAULT_COEFFICIENT = 0.5;
        ...
        public void RandomProbabilityChecker_IsNull_ConstructorExceptionTest()
        {
            Assert.Throws<ArgumentNullException>(
                () => new NonLinearRankingIndividualsSelector<ICalculatedIndividual>(DEFAULT_COEFFICIENT,
                    null,
        ...
        public void ReturnInividualsCountEqualToSelectionCount_SelectIndividualsTest(int selectionCount)
        {
            ...
            // Act
            var testObj = new NonLinearRankingIndividualsSelector<ICalculatedIndividual>(DEFAULT_COEFFICIENT,
                RandomProbabilityChecker,
                selectionCount);

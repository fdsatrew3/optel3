...
namespace GeneticAlgorithmTest.Operators.Crossovers.Selectors
{
    public class PanmixianCrossoverOperatorSelectorTest
    {
        ...
        public void IndividualsSelector_IsNull_ConstructorExceptionTest()
        {
            ...
            Assert.Throws<ArgumentNullException>(
                () => new PanmixianCrossoverOperatorSelector<ICalculatedIndividual>(Random, null)
                );
        }
        ...
        public void ReturnSettedCountOfIndividuals_SelectIndividualsTest(int individualsCount)
        {
            ...
            // Act
            var testObject = new PanmixianCrossoverOperatorSelector<ICalculatedIndividual>(Random, IndividualsSelector);

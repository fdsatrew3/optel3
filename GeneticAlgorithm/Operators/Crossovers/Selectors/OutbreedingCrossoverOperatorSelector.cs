...
{
    public class OutbreedingCrossoverOperatorSelector<I> : CrossoverOperatorSelector<I>
        where I : ICalculatedIndividual
    {
        public OutbreedingCrossoverOperatorSelector(IIndividualsSelector<I> individualsSelector) : base(individualsSelector)
        {
        ...
        protected override I SelectSecondParent(I firstParent, ICollection<I> parentsPull)
        {
            ...
            double minDifference = double.MinValue;
